            ...
            <div class="row">
                ...
                <div class="col-md-11 mx-auto">
                    ...
                    <div class="card card-secondary">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="/item/save" method="POST" class="d-inline">
                                ...
                                <div class="form-group">
                                    ...
                                    " name="rek" autofocus value="<?= old('rek'); ?>" id="rek" placeholder="Kode Rekening">
                                ...
                                <div class="form-group">
                                    ...
                                    " name="uraian" autofocus value="<?= old('uraian'); ?>" id="uraian" placeholder="Uraian">
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    " name="anggaran" autofocus value="<?= old('anggaran'); ?>" id="anggaran" placeholder="anggaran">
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    " name="sisa" autofocus value="<?= old('sisa'); ?>" id="sisa" placeholder="sisa">
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    " name="cair" autofocus value="<?= old('cair'); ?>" id="cair" placeholder="cair">
                                    <div class="invalid-feedback">
