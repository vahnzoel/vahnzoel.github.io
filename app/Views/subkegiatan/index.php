                        ...
                        <div class="card">
                            <div class="card-header">
                                <?php if (session()->get('id') != 2) { ?>
                                    <a class="btn btn-info btn-sm" href="/crsubkegiatan">Tambah</a>
                                <?php } ?>
                                <div class="card-tools">
                                    <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" action="/subkegiatan" method="POST">
                                    ...
                                    <tbody>
                                        <?php foreach ($sub as $S) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <center><?= $S['keterangan_sub']; ?></center>
                                                </td>
                                                <?php if (session()->get('id') != 2) { ?>
                                                    <td class="project-actions text-right">
                                                        <center><a class="btn btn-info btn-sm" href="/edsubkegiatan/<?= $S['slug_sub']; ?>">
                                                                <i class="fas fa-pencil-alt">
                                                                </i>
                                                                Edit
                                                            </a>
                                                            <form action="/delsubkegiatan/<?= $S['id_sub']; ?>" method="POST" class="d-inline">
                                                                <?= csrf_field(); ?>
